<%-- 
    Document   : shop_1
    Created on : Aug 6, 2019, 7:03:50 PM
    Author     : tawandamuyambo
--%>
...
<!-- css -->
<link href="resources/cssf/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<link rel="stylesheet" href="resources/cssf/style.css" type="text/css" media="all">
...
<div class="top-products">
		...
		<div class="sap_tabs">			
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				...
				<div class="resp-tabs-container">
					<h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Men's</h2><div class="tab-1 resp-tab-content resp-tab-content-active" style="display:block" aria-labelledby="tab_item-0">
					...
					<h2 class="resp-accordion" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span>Women</h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
					...
					<h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span>Handbags</h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
					...
					<h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span>Cosmetics</h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
	...
	<script src="resources/jsf/easyResponsiveTabs.js" type="text/javascript"></script>
	...
	<div class="container">
		...
		<div class="col-md-6 testimonials">
			<div class="test-inner">
				<div class="wmuSlider example1 animated wow slideInUp" data-wow-delay=".5s" style="height: 311px;">
		...
		<div class="clearfix"></div>
				...
				<script src="resources/jsf/jquery.wmuSlider.js"></script> 
								<script>
									$('.example1').wmuSlider();         
								</script> 
</div>
		...
		<div class="container">
			...
			<div class="sliderfig">
				...
				<li class="nbs-flexisel-item" style="width: 285px;">
					...
					<script type="text/javascript" src="resources/jsf/jquery.flexisel.js"></script>
		</div>
	</div>
<!-- //top-brands -->
<!-- newsletter -->
...
<div class="footer">
	...
	<!-- cart-js -->
	<script src="resources/jsf/minicart.js"></script>
	<script>
        w3ls1.render();
    ...
    </script><div id="PPsbmincart"><form method="post" class="" action="https://www.paypal.com/cgi-bin/webscr" target="">    <button type="button" class="sbmincart-closer">×</button>    <ul>                <li class="sbmincart-item">            <div class="sbmincart-details-name">                <a class="sbmincart-name" href="file:///media/tawandamuyambo/New%20Volume1/fashionshop/web/index.html">Blazer</a>                <ul class="sbmincart-attributes">                                                                            </ul>            </div>            <div class="sbmincart-details-quantity">                <input class="sbmincart-quantity" data-sbmincart-idx="0" name="quantity_1" type="text" pattern="[0-9]*" value="1" autocomplete="off">            </div>            <div class="sbmincart-details-remove">                <button type="button" class="sbmincart-remove" data-sbmincart-idx="0">×</button>            </div>            <div class="sbmincart-details-price">                <span class="sbmincart-price">$160.00</span>            </div>            <input type="hidden" name="w3ls1_item_1" value="Blazer">            <input type="hidden" name="amount_1" value="160">            <input type="hidden" name="shipping_1" value="undefined">            <input type="hidden" name="shipping2_1" value="undefined">        </li>                <li class="sbmincart-item">            <div class="sbmincart-details-name">                <a class="sbmincart-name" href="file:///media/tawandamuyambo/New%20Volume1/fashionshop/web/index.html">Shoes</a>                <ul class="sbmincart-attributes">                                                                            </ul>            </div>            <div class="sbmincart-details-quantity">                <input class="sbmincart-quantity" data-sbmincart-idx="1" name="quantity_2" type="text" pattern="[0-9]*" value="1" autocomplete="off">            </div>            <div class="sbmincart-details-remove">                <button type="button" class="sbmincart-remove" data-sbmincart-idx="1">×</button>            </div>            <div class="sbmincart-details-price">                <span class="sbmincart-price">$150.00</span>            </div>            <input type="hidden" name="w3ls1_item_2" value="Shoes">            <input type="hidden" name="amount_2" value="150">            <input type="hidden" name="shipping_2" value="undefined">            <input type="hidden" name="shipping2_2" value="undefined">        </li>                <li class="sbmincart-item sbmincart-item-changed">            <div class="sbmincart-details-name">                <a class="sbmincart-name" href="file:///media/tawandamuyambo/New%20Volume1/fashionshop/web/index.html">Inner wear</a>                <ul class="sbmincart-attributes">                                                                            </ul>            </div>            <div class="sbmincart-details-quantity">                <input class="sbmincart-quantity" data-sbmincart-idx="2" name="quantity_3" type="text" pattern="[0-9]*" value="1" autocomplete="off">            </div>            <div class="sbmincart-details-remove">                <button type="button" class="sbmincart-remove" data-sbmincart-idx="2">×</button>            </div>            <div class="sbmincart-details-price">                <span class="sbmincart-price">$50.00</span>            </div>            <input type="hidden" name="w3ls1_item_3" value="Inner wear">            <input type="hidden" name="amount_3" value="50">            <input type="hidden" name="shipping_3" value="undefined">            <input type="hidden" name="shipping2_3" value="undefined">        </li>            </ul>    <div class="sbmincart-footer">                    <div class="sbmincart-subtotal">                Subtotal: $360.00 USD            </div>                      </div>    <input type="hidden" name="cmd" value="_cart">    <input type="hidden" name="upload" value="1">            <input type="hidden" name="bn" value="sbmincart_AddToCart_WPS_US">    </form></div>  
	<!-- //cart-js -->  
