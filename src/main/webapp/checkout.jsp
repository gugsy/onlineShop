        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li><a href="shopf.html">Shop</a></li>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="${pageContext.request.contextPath}/paymentInfo" method="post">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="name" id="first_name" value="" placeholder="First Name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="surname" id="last_name"  value="" placeholder="Last Name" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" name="companyName" id="company" placeholder="Company Name" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                           ...
                           <!-- <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="shopf.html">Shop</a>
                                        </li>
                                        <li class="nav-item">
