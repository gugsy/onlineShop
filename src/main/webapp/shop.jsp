...
<form id="formT" data-parsley-validate novalidate action="${pageContext.request.contextPath}/addToCart" method="post">
					...
					<div class="form-group">
						<div class="input-group">
								<input type="hidden" name= "itemID" class="form-control" value="${id}">
								<input type="text" placeholder="Quantity" name= "quantity" class="form-control">

                                                </div>
					</div>     
                                                
					<button class="btn btn-custom-primary btn-lg btn-block btn-auth"><i class="fa fa-arrow-circle-o-right"></i> ADD TO CART</button>
				</form>
