...
<body>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/);">        
            ...
            <div class="card-body">
                <form  action="${pageContext.request.contextPath}/update" action="post">
                    <h3 class="box-title m-b-20">Update Rate</h3>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="rate" required="" placeholder="Username"> </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="addUser.jsp" class="text-info m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
    ...
    <!--Menu sidebar -->
    <script src="resources1/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="resources1/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <!--Custom JavaScript -->
    <script src="resources1/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="resources1/assets/plugins/styleswitcher/jQuery.style.switcher.js"></script>
</body>
