...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="cart-table-area section-padding-100">
             <form id="shopping-cart" action="${pageContext.request.contextPath}/processUpdate" method="get">
                     ...
                     <c:set var="name" value="${lines.getProductName()}"/>
                                ...
                                <img class="hover-img" src="resources/img/product2.jpg" alt="">
                                    ...
                                    <c:out value="${lines.getProductName()}"/>
                                        ...
                                        <td class="qty">
                				<input type="text" name= "quantity" class="form-control" value="${lines.getQuantity()}">
                                        </td>
...
<div class="col-12 col-lg-12" id="shopping-cart-actions">
                  ...
                  <a href="${pageContext.request.contextPath}/viewProducts" class="btn">Continue Shopping</a>
                            ...
                            <div class="cart-btn mt-100">
                                <input type="submit" class="btn amado-btn w-100" value="Confirm Update">
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="resources/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
                        <p class="copywrite"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright ©<script>document.write(new Date().getFullYear());</script>20192019 All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
